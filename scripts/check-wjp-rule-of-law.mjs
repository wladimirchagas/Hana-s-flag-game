...
for (const [label, src, needle] of [
  ...
  ["EntitySummary.tsx", summarySrc, 'case "wjp-rule-of-law"'],
  ["EntitySummary.tsx", summarySrc, "getDemocracyIndexMenuGroups"],
  ["EntitySummary.tsx", summarySrc, "getDemocracyIndexLabel"],
]) {
