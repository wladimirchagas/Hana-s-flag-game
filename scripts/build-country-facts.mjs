...
// Democracy ratings/ranks (Freedom House, V-Dem, EIU Economist), and the
// Corruption Perceptions Index (Transparency International).
//
// Source: mledoze/countries, World Bank API (NY.GDP.MKTP.CD, NY.GDP.MKTP.CN,
// NY.GDP.PCAP.CD, NY.GDP.PCAP.CN), curated Democracy index datasets, and
// Transparency International CPI (scripts/data/cpi2025Data.mjs).
//
...
// GDP, GDP per capita, democracy ratings/ranks, Corruption Perceptions Index) for every UN member / permanent-observer state.
