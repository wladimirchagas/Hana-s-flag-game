...
// GDP, GDP per capita, democracy ratings/ranks, Corruption Perceptions Index, Democracy Perception Index, RSF Press Freedom, Human Development Index) for every UN member / permanent-observer state.
// Sourced from mledoze/countries, World Bank API, Freedom House, V-Dem, EIU Economist, Transparency International CPI, Nira Data DPI, RSF, UNDP HDR.
//
