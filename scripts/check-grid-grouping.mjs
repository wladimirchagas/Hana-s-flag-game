...
for (const ct of ALL_CONTENT_TYPES) {
  for (const demoMode of ["freedom-house", "v-dem", "economist", "cpi", "perception", "rsf-press", "hdi", "gender-gap", "gpi", "happiness", "gdi", "wjp-rule-of-law", "imd-competitiveness", "etr", "soft-power"]) {
    assert.equal(
