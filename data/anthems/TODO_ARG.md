# TODO: Argentina (ARG / AR)

**Gap category:** `instrumental_audio_only`
**Official language(s):** es
**Wikipedia anthem slug (guess):** `Argentine_National_Anthem`
...
- `Himno Nacional Argentino vocal sung Argentina`
- `Argentina national anthem`
- `United States Navy Band - Himno Nacional Argentino`
