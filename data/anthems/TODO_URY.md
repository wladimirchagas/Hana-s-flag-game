...
**Wikipedia anthem slug (guess):** `National_Anthem_of_Uruguay`

## Status
Lyrics are present (12 lines), but the existing
`wikiFile` is an instrumental rendition:

> `United States Navy Band - National Anthem of Uruguay (short with intro).ogg`
...
- `United States Navy Band - National Anthem of Uruguay (short with intro)`
