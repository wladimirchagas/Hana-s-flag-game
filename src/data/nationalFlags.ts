...
export const NATIONAL_FLAGS: Readonly<Record<string, readonly NationalFlag[]>> = {
  ...
  "AE": [
    ...
    { id: "ae-uk", category: "historical", name: "Flag of the United Kingdom", from: 1892, to: 1971, sovereign: "the United Kingdom", path: "national-flags/ae/ae-uk.svg", design: "The Union Flag, flown while the emirates were the British-protected Trucial States.", source: "https://en.wikipedia.org/wiki/Trucial_States" },
  ...
  "AT": [
    ...
    { id: "at-habsburg", category: "historical", name: "Flag of the Habsburg Monarchy", from: 1804, to: 1918, path: "national-flags/at/habsburg.svg", design: "A black-over-gold horizontal bicolour, the dynastic colours of the House of Habsburg, flown as the flag of the Austrian Empire and Austria-Hungary until the monarchy fell in 1918. The red-white-red now flown is far older, dating to the medieval Babenberg dukes.", source: "https://en.wikipedia.org/wiki/Flag_of_Austria" },
  ...
  "AZ": [
    ...
    { id: "az-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1828, to: 1917, sovereign: "the Russian Empire", path: "national-flags/az/az-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled the Azerbaijani khanates from 1828 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "BE": [
    ...
    { id: "be-football-crest", category: "footballcrest", name: "Crest of the Belgium national football team", path: "national-flags/be/be-football-crest.svg", design: "The crest of the Belgium national football team — a gold shield banded in the national black, yellow and red, under a royal crown, reading “ROYAL BELGIAN FA · 1895”, with laurel branches below.", source: "https://en.wikipedia.org/wiki/Belgium_national_football_team" },
  ],
  "BF": [
  ...
  "BN": [
    ...
    { id: "bn-uk", category: "historical", name: "Flag of the United Kingdom", from: 1888, to: 1984, sovereign: "the United Kingdom", path: "national-flags/bn/bn-uk.svg", design: "The Union Flag, flown while Brunei was a British protected state until independence in 1984.", source: "https://en.wikipedia.org/wiki/History_of_Brunei" },
  ...
  "BW": [
    ...
    { id: "bw-passport", category: "passport", name: "Passport of Botswana", path: "national-flags/bw/bw-passport.webp", design: "The cover of the Botswana passport.", source: "https://gicg.net/passport/bw/" },
  ],
  "BY": [
    ...
    { id: "by-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1795, to: 1917, sovereign: "the Russian Empire", path: "national-flags/by/by-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled Belarus from 1795 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "CA": [
    ...
    { id: "ca-football-crest", category: "footballcrest", name: "Crest of the Canada national soccer team", path: "national-flags/ca/ca-football-crest.svg", design: "The crest of Canada Soccer — a red maple leaf above a soccer ball and the word CANADA.", source: "https://en.wikipedia.org/wiki/Canada_Soccer" },
  ],
  "CD": [
  ...
  "CH": [
    ...
    { id: "ch-helvetic", category: "historical", name: "Flag of the Helvetic Republic", from: 1798, to: 1803, path: "national-flags/ch/helvetic.svg", design: "A green-red-yellow horizontal tricolour, the flag of the short-lived Helvetic Republic set up under French influence from 1798 to 1803. The white cross on red returned when the Confederation was restored.", source: "https://en.wikipedia.org/wiki/Flag_of_Switzerland" },
  ...
  "CZ": [
    ...
    { id: "cz-bohemia", category: "historical", name: "Flag of Bohemia", from: 1918, to: 1920, path: "national-flags/cz/bohemia.svg", design: "A white-over-red horizontal bicolour, the historic flag of the Kingdom of Bohemia and the Czech lands. It served as Czechoslovakia's first national flag from 1918 until the blue hoist triangle — used to distinguish it from Poland's flag — was added in 1920.", source: "https://en.wikipedia.org/wiki/Flag_of_the_Czech_Republic" },
  ...
  "DE": [
    ...
    { id: "de-east-germany", category: "historical", name: "Flag of East Germany", from: 1959, to: 1990, path: "national-flags/de/east-germany.svg", design: "The black-red-gold tricolour charged with the state emblem of the German Democratic Republic — a hammer and a pair of compasses within a ring of rye. Used from 1959; before that East Germany flew the plain tricolour. East Germany reunified with the Federal Republic in 1990.", source: "https://en.wikipedia.org/wiki/Flag_of_East_Germany" },
    { id: "de-nazi", category: "historical", name: "Flag of Germany (1935–1945)", from: 1935, to: 1945, path: "national-flags/de/germany-1935.svg", design: "A red field bearing a white disc charged with a black swastika. Under Nazi rule it was made the sole national flag of Germany in 1935 and flown until the regime's defeat in 1945, when it was abolished.", source: "https://en.wikipedia.org/wiki/Flag_of_Germany" },
    { id: "de-empire", category: "historical", name: "Flag of the German Empire", from: 1867, to: 1918, path: "national-flags/de/germany-1867.svg", design: "The black-white-red horizontal tricolour, first of the North German Confederation from 1867 and then of the German Empire from 1871, flown until the empire fell in 1918.", source: "https://en.wikipedia.org/wiki/Flag_of_Germany" },
  ...
  "DO": [
    ...
    { id: "do-passport", category: "passport", name: "Passport of the Dominican Republic", path: "national-flags/do/do-passport.webp", design: "The cover of the the Dominican Republic passport.", source: "https://gicg.net/passport/do/" },
    { id: "do-football-crest", category: "footballcrest", name: "Crest of the Dominican Republic national football team", path: "national-flags/do/do-football-crest.svg", design: "The crest of the Dominican Republic national football team.", source: "https://en.wikipedia.org/wiki/Dominican_Republic_national_football_team" },
  ],
  "DZ": [
  ...
  "EE": [
    ...
    { id: "ee-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1721, to: 1917, sovereign: "the Russian Empire", path: "national-flags/ee/ee-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled Estonia from 1721 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
    ...
    { id: "ee-naval-jack", category: "maritime", name: "Naval jack of Estonia", path: "national-flags/ee/estonia-naval-jack.svg", design: "A white field with a black saltire and a blue cross.", source: "https://en.wikipedia.org/wiki/List_of_Estonian_flags" },
  ...
  "EG": [
    ...
    { id: "eg-football-crest", category: "footballcrest", name: "Crest of the Egypt national football team", path: "national-flags/eg/eg-football-crest.svg", design: "The crest of the Egypt national football team — a black-and-white football with red, white and black rays fanning outward, ringed by the association's name in Arabic and, beneath, “EGYPTIAN FA”.", source: "https://en.wikipedia.org/wiki/Egypt_national_football_team" },
  ],
  "ER": [
  ...
  "ES": [
    ...
    { id: "es-football-crest", category: "footballcrest", name: "Crest of the Spain national football team (RFEF)", path: "national-flags/es/es-football-crest.svg", design: "The crest the Spain national team wears — the crowned arms of Spain flanked by the Pillars of Hercules bearing the motto PLVS VLTRA, above a roundel reading 1909 · RFEF, beneath two gold stars.", source: "https://en.wikipedia.org/wiki/Spain_national_football_team" },
  ],
  "ET": [
  ...
  "FI": [
    ...
    { id: "fi-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1809, to: 1917, sovereign: "the Russian Empire", path: "national-flags/fi/fi-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled Finland from 1809 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "GE": [
    ...
    { id: "ge-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1801, to: 1917, sovereign: "the Russian Empire", path: "national-flags/ge/ge-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled Georgia from 1801 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "GH": [
    ...
    { id: "gh-football-crest", category: "footballcrest", name: "Crest of the Ghana national football team", path: "national-flags/gh/gh-football-crest.svg", design: "The crest of the Ghana national football team — a red-yellow-green ribbon bearing a black star, wrapped around a black-and-white football and ringed in the national colours, with the words “GHANA FOOTBALL ASSOCIATION”.", source: "https://en.wikipedia.org/wiki/Ghana_national_football_team" },
  ],
  "GI": [
  ...
  "GR": [
    ...
    { id: "gr-kingdom", category: "historical", name: "State flag of the Kingdom of Greece", from: 1863, to: 1973, path: "national-flags/gr/kingdom.svg", design: "A blue field with a white cross throughout and the royal crown at the centre — the state flag of the Kingdom of Greece under the House of Glücksburg (1863–1924 and 1935–1973). The crown was dropped when the monarchy was abolished.", source: "https://en.wikipedia.org/wiki/Flag_of_Greece" },
  ...
  "HR": [
    ...
    { id: "hr-civil-ensign", category: "maritime", name: "Civil and state ensign of Croatia", path: "national-flags/hr/croatia-civil-ensign.svg", design: "Identical to the national flag, but in 2:3 proportions.", source: "https://en.wikipedia.org/wiki/List_of_Croatian_flags" },
    { id: "hr-naval-jack", category: "maritime", name: "Naval jack of Croatia", path: "national-flags/hr/croatia-naval-jack.svg", design: "A blue field with a red and white border, bearing the national coat of arms and two crossed anchors in the centre.", source: "https://en.wikipedia.org/wiki/List_of_Croatian_flags" },
    ...
    { id: "hr-football-crest", category: "footballcrest", name: "Crest of the Croatia national football team", path: "national-flags/hr/hr-football-crest.svg", design: "The crest of the Croatia national football team — a red-and-white checkerboard shield (the šahovnica) with a blue band reading “HNS”, above a gold football.", source: "https://en.wikipedia.org/wiki/Croatia_national_football_team" },
  ],
  "HT": [
  ...
  "ID": [
    ...
    { id: "id-nl", category: "historical", name: "Flag of the Netherlands", from: 1816, to: 1945, sovereign: "the Netherlands", path: "national-flags/id/id-nl.svg", design: "The flag of the Netherlands, flown over the Netherlands East Indies until 1945.", source: "https://en.wikipedia.org/wiki/Dutch_East_Indies" },
  ...
  "IL": [
    ...
    { id: "il-uk", category: "historical", name: "Flag of the United Kingdom", from: 1920, to: 1948, sovereign: "the United Kingdom", path: "national-flags/il/il-uk.svg", design: "The Union Flag, the Union Flag of the British Mandate for Palestine.", source: "https://en.wikipedia.org/wiki/Mandatory_Palestine" },
  ...
  "IT": [
    ...
    { id: "it-kingdom", category: "historical", name: "Flag of the Kingdom of Italy", from: 1861, to: 1946, path: "national-flags/it/kingdom-1861.svg", design: "The green-white-red tricolour charged with the coat of arms of the House of Savoy — a white cross on red within a blue border. Flown by the Kingdom of Italy from unification in 1861 until the 1946 referendum made Italy a republic and left the plain tricolour.", source: "https://en.wikipedia.org/wiki/Flag_of_Italy" },
  ...
  "KR": [
    ...
    { id: "kr-japan", category: "historical", name: "Flag of Japan", from: 1910, to: 1945, sovereign: "the Empire of Japan", path: "national-flags/kr/kr-japan.svg", design: "The Hinomaru, flown over Korea throughout Japanese colonial rule from the 1910 annexation until liberation in 1945.", source: "https://en.wikipedia.org/wiki/Korea_under_Japanese_rule" },
    { id: "kr-korean-empire", category: "historical", name: "Flag of the Korean Empire", from: 1882, to: 1910, priorPolity: "the Korean Empire", path: "national-flags/kr/kr-korean-empire.svg", design: "The Taegukgi of the Korean Empire (and the preceding Joseon kingdom), the last flag of an independent Korean state before Japan annexed the peninsula in 1910.", source: "https://en.wikipedia.org/wiki/Korean_Empire" },
    { id: "kr-army", category: "military", name: "Flag of the Republic of Korea Army", path: "national-flags/kr/army.svg", design: "The service flag of the Republic of Korea Army — a white field bearing the Army emblem.", source: "https://en.wikipedia.org/wiki/Republic_of_Korea_Armed_Forces" },
    { id: "kr-navy", category: "military", name: "Flag of the Republic of Korea Navy", path: "national-flags/kr/navy.svg", design: "The service flag of the Republic of Korea Navy — a white field bearing the Navy anchor emblem.", source: "https://en.wikipedia.org/wiki/Republic_of_Korea_Armed_Forces" },
    { id: "kr-airforce", category: "military", name: "Flag of the Republic of Korea Air Force", path: "national-flags/kr/airforce.svg", design: "The service flag of the Republic of Korea Air Force — a blue field bearing the Air Force emblem.", source: "https://en.wikipedia.org/wiki/Republic_of_Korea_Armed_Forces" },
    { id: "kr-marines", category: "military", name: "Flag of the Republic of Korea Marine Corps", path: "national-flags/kr/marines.svg", design: "The service flag of the Republic of Korea Marine Corps — a red field bearing the Corps emblem.", source: "https://en.wikipedia.org/wiki/Republic_of_Korea_Armed_Forces" },
  ...
  "KZ": [
    ...
    { id: "kz-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1731, to: 1917, sovereign: "the Russian Empire", path: "national-flags/kz/kz-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled the Kazakh steppe from 1731 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "LK": [
    ...
    { id: "lk-uk", category: "historical", name: "Flag of the United Kingdom", from: 1815, to: 1948, sovereign: "the United Kingdom", path: "national-flags/lk/lk-uk.svg", design: "The Union Flag, flown while Ceylon (now Sri Lanka) was a British Crown colony.", source: "https://en.wikipedia.org/wiki/British_Ceylon" },
  ...
  "LT": [
    ...
    { id: "lt-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1795, to: 1917, sovereign: "the Russian Empire", path: "national-flags/lt/lt-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled Lithuania from 1795 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "LV": [
    ...
    { id: "lv-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1795, to: 1917, sovereign: "the Russian Empire", path: "national-flags/lv/lv-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled the Latvian lands from 1795 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "LY": [
    ...
    { id: "ly-italy", category: "historical", name: "Flag of the Kingdom of Italy", from: 1911, to: 1943, sovereign: "the Kingdom of Italy", path: "national-flags/ly/ly-italy.svg", design: "The flag of the Kingdom of Italy, flown over Italian Libya from 1911 until the Italian defeat in 1943; Libya became independent in 1951.", source: "https://en.wikipedia.org/wiki/Italian_Libya" },
  ...
  "MG": [
    ...
    { id: "mg-passport", category: "passport", name: "Passport of Madagascar", path: "national-flags/mg/mg-passport.webp", design: "The cover of the Madagascar passport.", source: "https://gicg.net/passport/mg/" },
  ],
  "MH": [
  ...
  "MM": [
    ...
    { id: "mm-uk", category: "historical", name: "Flag of the United Kingdom", from: 1886, to: 1948, sovereign: "the United Kingdom", path: "national-flags/mm/mm-uk.svg", design: "The Union Flag, flown while Burma (now Myanmar) was a British colony.", source: "https://en.wikipedia.org/wiki/British_rule_in_Burma" },
  ...
  "MN": [
    ...
    { id: "mn-qing", category: "historical", name: "Flag of the Qing dynasty", from: 1691, to: 1911, sovereign: "the Qing Empire", path: "national-flags/mn/mn-qing.svg", design: "The yellow dragon banner of Qing China, whose rule over Outer Mongolia ended when it declared independence in 1911.", source: "https://en.wikipedia.org/wiki/Bogd_Khanate_of_Mongolia" },
  ...
  "MX": [
    ...
    { id: "mx-spain-1785", category: "historical", name: "Flag of the Kingdom of Spain", from: 1785, to: 1821, sovereign: "Spain", path: "historical-flags/spain-1785.png", design: "The red-yellow-red ensign of 1785 with the royal arms, flown in the last decades of Spanish rule.", source: "https://en.wikipedia.org/wiki/Flag_of_Spain" },
    { id: "mx-burgundy", category: "historical", name: "Cross of Burgundy", from: 1521, to: 1785, sovereign: "Spain", path: "historical-flags/spain-burgundy.png", design: "A red ragged saltire on white — the ensign of the Spanish Empire, flown over New Spain from the conquest.", source: "https://en.wikipedia.org/wiki/Cross_of_Burgundy" },
  ...
  "MY": [
    ...
    { id: "my-civil-ensign", category: "maritime", name: "Civil ensign of Malaysia", path: "national-flags/my/malaysia-civil-ensign.svg", design: "A red field with the flag of Malaysia in a blue-fimbriated canton — worn by Malaysian merchant ships.", source: "https://en.wikipedia.org/wiki/List_of_Malaysian_flags" },
  ...
  "NG": [
    ...
    { id: "ng-uk", category: "historical", name: "Flag of the United Kingdom", from: 1914, to: 1960, sovereign: "the United Kingdom", path: "national-flags/ng/ng-uk.svg", design: "The Union Flag, flown over the British colony of Nigeria until independence in 1960.", source: "https://en.wikipedia.org/wiki/Colonial_Nigeria" },
  ...
  "NL": [
    ...
    { id: "nl-prinsenvlag", category: "historical", name: "Prince's Flag (Prinsenvlag)", from: 1572, to: 1660, path: "national-flags/nl/prinsenvlag.svg", design: "Orange, white and blue horizontal bands — the flag of the Dutch Revolt under William of Orange from the 1570s. Through the 17th century the orange band was gradually replaced by red, producing today's red-white-blue.", source: "https://en.wikipedia.org/wiki/Flag_of_the_Netherlands" },
    ...
    { id: "nl-naval-jack", category: "maritime", name: "Naval jack of the Netherlands (the “Geus”)", from: 1931, to: 9999, path: "national-flags/nl/netherlands-naval-jack.svg", design: "Twelve segments in the colours of the kingdom flag, in the ratio 2:3.", source: "https://en.wikipedia.org/wiki/List_of_flags_of_the_Netherlands" },
  ...
  "PH": [
    ...
    { id: "ph-football-crest", category: "footballcrest", name: "Crest of the Philippine Football Federation (PFF)", path: "national-flags/ph/ph-football-crest.svg", design: "The crest of the Philippine Football Federation — a circular blue-and-gold badge with a football before a red-and-blue goal, the letters PFF, two stars and the founding year 1907.", source: "https://en.wikipedia.org/wiki/Philippine_Football_Federation" },
  ],
  "PK": [
    ...
    { id: "pk-uk", category: "historical", name: "Flag of the United Kingdom", from: 1858, to: 1947, sovereign: "the United Kingdom", path: "national-flags/pk/pk-uk.svg", design: "The Union Flag, flown over British India until partition and independence in 1947.", source: "https://en.wikipedia.org/wiki/British_Raj" },
  ...
  "PL": [
    ...
    { id: "pl-football-crest", category: "footballcrest", name: "Crest of the Poland national football team", path: "national-flags/pl/pl-football-crest.svg", design: "The crest of the Poland national football team — a red-and-gold abstract mark of swirling wing shapes evoking an eagle in flight, above a football, under a gold crown, with the letters “PZPN” below.", source: "https://en.wikipedia.org/wiki/Polish_Football_Association" },
  ],
  "PN": [
  ...
  "RO": [
    ...
    { id: "ro-communist", category: "historical", name: "Flag of Romania (1965–1989)", from: 1965, to: 1989, path: "national-flags/ro/communist-1965.svg", design: "The blue-yellow-red tricolour charged in the yellow band with the emblem of the Socialist Republic of Romania — a wooded mountain landscape beneath a rising sun with a derrick and a star, within a wheat wreath. Torn out by revolutionaries in December 1989, leaving the plain tricolour.", source: "https://en.wikipedia.org/wiki/Flag_of_Romania" },
  ...
  "SA": [
    ...
    { id: "sa-football-crest", category: "footballcrest", name: "Crest of the Saudi Arabia national football team", path: "national-flags/sa/sa-football-crest.svg", design: "The crest of the Saudi Arabian Football Federation — a green-and-white circular badge built around a stylised falcon's head merged with a football, the letters “SAFF” inside the ball, ringed by the country's name in Arabic and “KSA” below.", source: "https://en.wikipedia.org/wiki/Saudi_Arabia_national_football_team" },
  ],
  "SB": [
  ...
  "SD": [
    ...
    { id: "sd-uk", category: "historical", name: "Flag of the United Kingdom", from: 1899, to: 1956, sovereign: "the United Kingdom", path: "national-flags/sd/sd-uk.svg", design: "The Union Flag of the Anglo-Egyptian condominium that governed Sudan until independence in 1956.", source: "https://en.wikipedia.org/wiki/Anglo-Egyptian_Sudan" },
  ...
  "SE": [
    ...
    { id: "se-union-1844", category: "historical", name: "Flag of Sweden (1844–1905)", from: 1844, to: 1905, path: "national-flags/se/union-1844.svg", design: "The blue-and-yellow Nordic cross defaced in the canton with the Swedish–Norwegian union badge, flown during the union with Norway until the union was dissolved in 1905.", source: "https://en.wikipedia.org/wiki/Flag_of_Sweden" },
    ...
    { id: "se-football-crest", category: "footballcrest", name: "Crest of the Sweden national football team", path: "national-flags/se/se-football-crest.svg", design: "The crest of the Sweden national football team — a blue shield bearing the yellow Nordic cross of the national flag, under a football and the words “SVENSKA FOTBOLLFÖRBUNDET · 1904”, above a “SVERIGE” banner.", source: "https://en.wikipedia.org/wiki/Sweden_men's_national_football_team" },
  ],
  "SG": [
  ...
  "SK": [
    ...
    { id: "sk-1939", category: "historical", name: "Flag of Slovakia (1939–1945)", from: 1939, to: 1945, path: "national-flags/sk/slovakia-1939.svg", design: "The plain white-blue-red Pan-Slavic tricolour without the national arms, flown by the first Slovak Republic (1939–1945). Slovakia's present flag added the coat of arms in 1992 to distinguish the tricolour from Russia's and Slovenia's.", source: "https://en.wikipedia.org/wiki/Flag_of_Slovakia" },
    ...
    { id: "sk-passport", category: "passport", name: "Passport of Slovakia", path: "national-flags/sk/sk-passport.webp", design: "The cover of the Slovakia passport.", source: "https://gicg.net/passport/sk/" },
  ],
  "SL": [
  ...
  "SN": [
    ...
    { id: "sn-passport", category: "passport", name: "Passport of Senegal", path: "national-flags/sn/sn-passport.webp", design: "The cover of the Senegal passport.", source: "https://gicg.net/passport/sn/" },
    { id: "sn-football-crest", category: "footballcrest", name: "Crest of the Senegal national football team", path: "national-flags/sn/sn-football-crest.svg", design: "The crest of the Senegalese Football Federation — two lions (the Lion of Teranga) in the national green, yellow and red, ringed by the federation name in French.", source: "https://en.wikipedia.org/wiki/Senegalese_Football_Federation" },
  ],
  "SO": [
  ...
  "SV": [
    ...
    { id: "sv-football-crest", category: "footballcrest", name: "Crest of the El Salvador national football team", path: "national-flags/sv/sv-football-crest.svg", design: "The crest of the Salvadoran Football Federation (FESFUT) — a football within a blue ring lettered “Federación Salvadoreña de Fútbol”, beside an “ES” badge.", source: "https://en.wikipedia.org/wiki/Salvadoran_Football_Federation" },
  ],
  "SX": [
  ...
  "TG": [
    ...
    { id: "tg-french", category: "historical", name: "Flag of France", from: 1916, to: 1960, sovereign: "France", path: "national-flags/tg/tg-french.svg", design: "The French Tricolour, flown over Togo under French colonial rule.", source: "https://en.wikipedia.org/wiki/French_colonial_empire" },
  ...
  "UA": [
    ...
    { id: "ua-russian-empire", category: "historical", name: "Flag of the Russian Empire", from: 1793, to: 1917, sovereign: "the Russian Empire", path: "national-flags/ua/ua-russian-empire.svg", design: "The white-blue-red flag of the Russian Empire, which ruled much of Ukraine from 1793 until the empire fell in 1917.", source: "https://en.wikipedia.org/wiki/Russian_Empire" },
  ...
  "UZ": [
    ...
    { id: "uz-ssr", category: "historical", name: "Flag of the Uzbek SSR", from: 1952, to: 1991, priorPolity: "the Uzbek Soviet Socialist Republic", path: "national-flags/uz/uz-ssr.svg", design: "Red with a white-edged blue stripe and the gold hammer, sickle and star — the republic's flag within the Soviet Union.", source: "https://en.wikipedia.org/wiki/Flag_of_Uzbekistan" },
  ...
  "VN": [
    ...
    { id: "vn-passport", category: "passport", name: "Passport of Vietnam", path: "national-flags/vn/vn-passport.webp", design: "The cover of the Vietnam passport.", source: "https://gicg.net/passport/vn/" },
    { id: "vn-football-crest", category: "footballcrest", name: "Crest of the Vietnam Football Federation (VFF)", path: "national-flags/vn/vn-football-crest.svg", design: "The crest of the Vietnam Football Federation — a football over a red disc bearing the gold star of the national flag, with the letters VFF.", source: "https://en.wikipedia.org/wiki/Vietnam_Football_Federation" },
  ],
  "VU": [
...
export const NATIONAL_INDEPENDENCE: Readonly<Record<string, NationalIndependence>> = {
  "AE": { year: 1971, event: "The United Arab Emirates was formed and gained independence from the United Kingdom on 2 December 1971", source: "https://en.wikipedia.org/wiki/Trucial_States" },
  ...
  "AZ": { year: 1918, event: "Azerbaijan first declared independence as the Azerbaijan Democratic Republic in 1918; after Soviet rule it regained independence from the Soviet Union in 1991", source: "https://en.wikipedia.org/wiki/Azerbaijan_Democratic_Republic" },
  ...
  "BH": { year: 1971, event: "Bahrain became independent from the United Kingdom on 15 August 1971", source: "https://en.wikipedia.org/wiki/History_of_Bahrain" },
  ...
  "FI": { year: 1917, event: "Finland declared independence from Russia on 6 December 1917, ending over a century as an autonomous Grand Duchy of the Russian Empire", source: "https://en.wikipedia.org/wiki/Finnish_Declaration_of_Independence" },
  ...
  "ID": { year: 1945, event: "Indonesia proclaimed independence from the Netherlands on 17 August 1945; the Netherlands recognised it in 1949 after an armed struggle", source: "https://en.wikipedia.org/wiki/Indonesian_National_Revolution" },
  ...
  "IL": { year: 1948, event: "Israel declared independence on 14 May 1948 as the British Mandate for Palestine ended", source: "https://en.wikipedia.org/wiki/Israeli_Declaration_of_Independence" },
  ...
  "IQ": { year: 1932, event: "Iraq became independent from the United Kingdom on 3 October 1932, ending the British Mandate", source: "https://en.wikipedia.org/wiki/Mandatory_Iraq" },
  ...
  "KG": { year: 1991, event: "Kyrgyzstan declared independence from the Soviet Union on 31 August 1991", source: "https://en.wikipedia.org/wiki/History_of_Kyrgyzstan" },
  ...
  "KR": { year: 1948, event: "The Republic of Korea was established on 15 August 1948; Korea had been liberated from 35 years of Japanese colonial rule in 1945 and divided into US- and Soviet-administered zones", source: "https://en.wikipedia.org/wiki/History_of_South_Korea" },
  ...
  "KZ": { year: 1991, event: "Kazakhstan declared independence from the Soviet Union on 16 December 1991", source: "https://en.wikipedia.org/wiki/History_of_Kazakhstan" },
  ...
  "LK": { year: 1948, event: "Ceylon (now Sri Lanka) became independent from the United Kingdom on 4 February 1948", source: "https://en.wikipedia.org/wiki/British_Ceylon" },
  ...
  "MA": { year: 1956, event: "Morocco regained independence from France on 2 March 1956, and from Spain later that year, ending the protectorates established in 1912", source: "https://en.wikipedia.org/wiki/French_protectorate_in_Morocco" },
  "MD": { year: 1991, event: "Moldova declared independence from the Soviet Union on 27 August 1991", source: "https://en.wikipedia.org/wiki/History_of_Moldova" },
  ...
  "MV": { year: 1965, event: "The Maldives became fully independent from the United Kingdom on 26 July 1965", source: "https://en.wikipedia.org/wiki/History_of_the_Maldives" },
  ...
  "MX": { year: 1821, event: "Mexico achieved independence from Spain on 27 September 1821 with the Treaty of Córdoba, after the war of independence begun in 1810", source: "https://en.wikipedia.org/wiki/Mexican_War_of_Independence" },
  ...
  "NG": { year: 1960, event: "Nigeria became independent from the United Kingdom on 1 October 1960", source: "https://en.wikipedia.org/wiki/Colonial_Nigeria" },
  ...
  "SD": { year: 1956, event: "Sudan became independent on 1 January 1956, ending the Anglo-Egyptian condominium", source: "https://en.wikipedia.org/wiki/Anglo-Egyptian_Sudan" },
  ...
  "TJ": { year: 1991, event: "Tajikistan declared independence from the Soviet Union on 9 September 1991", source: "https://en.wikipedia.org/wiki/History_of_Tajikistan" },
  ...
  "TM": { year: 1991, event: "Turkmenistan declared independence from the Soviet Union on 27 October 1991", source: "https://en.wikipedia.org/wiki/History_of_Turkmenistan" },
...
export const NATIONAL_FLAG_MEANINGS: Record<string, FlagMeaning> = {
  ...
  "be-football-crest": {
    ...
    sources: [
      { title: "Royal Belgian Football Association — Wikipedia", url: "https://en.wikipedia.org/wiki/Royal_Belgian_Football_Association" },
  ...
  "in-football-crest": {
    description: "The swept orange-white-green band is drawn from the Indian national flag as a rising flame, meant to stand for the vibrancy and forward momentum of the game in India; the shield shape frames the federation's own role — inclusive of, responsible for, and in authority over the sport nationally. The current mark was designed in 2016 after consultation with FIFA, AIFF officials, players and fans.",
    sources: [
  ...
  "ma-football-crest": {
    ...
    sources: [
      ...
      { title: "Morocco national football team — Wikipedia", url: "https://en.wikipedia.org/wiki/Morocco_national_football_team" },
    ],
  },
  "mc-arms": {
  ...
  "pl-football-crest": {
    ...
    sources: [
      { title: "Historical logos of the Polish Football Association — PZPN", url: "https://pzpn.pl/en/association/news/2019-07-01/historical-logos-of-the-polish-football-association" },
    ],
  },
  "pn-arms": {
  ...
  "sa-football-crest": {
    ...
    sources: [
      { title: "Saudi Arabia national football team — Wikipedia", url: "https://en.wikipedia.org/wiki/Saudi_Arabia_national_football_team" },
      { title: "Saudi Arabian Football Federation — Saudipedia", url: "https://saudipedia.com/en/article/1045/society/sports/saudi-arabian-football-federation" },
      { title: "Emblem of Saudi Arabia — Wikipedia", url: "https://en.wikipedia.org/wiki/Emblem_of_Saudi_Arabia" },
    ],
  },
  "sb-arms": {
  ...
  "sn-football-crest": {
    description: "The lions and the green-yellow-red repeat Senegal's own flag and give the team its nickname, the Lions of Teranga (Lions de la Teranga). Teranga is a Wolof word for hospitality and warmth toward guests — a value Senegal is widely known for and often called “the country of Teranga” — so the badge pairs the lion's strength with a value the nation prizes in itself.",
    sources: [
