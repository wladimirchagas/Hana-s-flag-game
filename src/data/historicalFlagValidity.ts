...
export const HISTORICAL_FLAG_VALIDITY: ReadonlyMap<string, FlagValidity> = new Map([
  ...
  ["historical-flags/mexico-1893.svg", { from: 1893, to: 1916, design: "Mexico — the green-white-red tricolour with the FRONT-FACING eagle, wings spread, on the cactus; the 1893 pattern, flown until Carranza's 1916 decree turned the eagle side-on.", source: "https://en.wikipedia.org/wiki/Flag_of_Mexico" }],
  ["historical-flags/mexico-1916.svg", { from: 1916, to: 1934, design: "Mexico — the eagle shown in PROFILE facing the hoist, per Venustiano Carranza's 1916 presidential decree; superseded by the 1934 pattern.", source: "https://en.wikipedia.org/wiki/Flag_of_Mexico" }],
  ["historical-flags/mexico-1934.svg", { from: 1934, to: 1968, design: "Mexico — the 1934 pattern, the eagle in profile within a full circular oak-and-laurel wreath; replaced on 16 September 1968 by the arms Francisco Eppens Helguera designed, which the modern flag carries.", source: "https://en.wikipedia.org/wiki/Flag_of_Mexico" }],
  ["historical-flags/venezuela-1930.svg", { from: 1930, to: 2006, design: "Venezuela — the yellow-blue-red tricolour with SEVEN stars in an arc, the civil flag flown from 1930 until an eighth star for Guayana Province was added on 12 March 2006.", source: "https://en.wikipedia.org/wiki/Flag_of_Venezuela" }],
  ["historical-flags/mexico-1823.svg", { from: 1823, to: 1893, design: "Mexico — the first federal republic's flag, the front-facing eagle on the cactus wreathed in oak and laurel. Flown 1823-1864 and again 1867-1893; INTERRUPTED 1864-1867 by the Second Mexican Empire, whose flag bore four eagles and an imperial crown.", source: "https://en.wikipedia.org/wiki/Flag_of_Mexico" }],
  ["historical-flags/venezuela-1863.svg", { from: 1863, to: 1905, design: "Venezuela — yellow-blue-red with SEVEN stars clustered in the blue band, the pattern adopted in 1863.", source: "https://en.wikipedia.org/wiki/Flag_of_Venezuela" }],
  ["historical-flags/venezuela-1905.svg", { from: 1905, to: 1930, design: "Venezuela — seven stars arranged in a CIRCLE in the blue band, the 1905 pattern; rearranged into an arc in 1930.", source: "https://en.wikipedia.org/wiki/Flag_of_Venezuela" }],
  ...
  ["historical-flags/orange-free-state.svg", { from: 1857, to: 1902, design: "Orange Free State — the Boer republic's orange-and-white stripes with the Dutch tricolour in the canton.", source: "https://en.wikipedia.org/wiki/Orange_Free_State" }],
  ...
  ["historical-flags/germany-nazi.svg", { from: 1933, to: 1945, design: "Red field with a white disc bearing a black swastika, the disc set slightly toward the hoist. Introduced as a co-national flag in 1933 and made the sole national flag of Germany from 1935 until the regime's defeat in 1945.", source: "https://en.wikipedia.org/wiki/Flag_of_Germany" }],
  ...
  ["historical-flags/nejd-1902.svg", { from: 1902, to: 1921, design: "Emirate of Nejd and Hasa — green with the shahada and crossed swords, the third Saudi state under Ibn Saud.", source: "https://en.wikipedia.org/wiki/Emirate_of_Nejd_and_Hasa" }],
  ["historical-flags/georgia-1918.svg", { from: 1918, to: 1921, design: "Democratic Republic of Georgia — dark red with black and white canton stripes.", source: "https://en.wikipedia.org/wiki/Democratic_Republic_of_Georgia" }],
  ["historical-flags/rwanda-1962.svg", { from: 1961, to: 2001, design: "Rwanda — red-yellow-green with a black R, flown from independence until the 2001 redesign.", source: "https://en.wikipedia.org/wiki/Flag_of_Rwanda" }],
  ["historical-flags/myanmar-1974.svg", { from: 1974, to: 2010, design: "Socialist Republic of the Union of Burma, then Myanmar — red with a blue canton and the cogwheel-and-rice emblem.", source: "https://en.wikipedia.org/wiki/Flag_of_Myanmar" }],
  ["historical-flags/lesotho-1987.svg", { from: 1987, to: 2006, design: "Lesotho — the diagonal flag with the Basotho shield and assegais.", source: "https://en.wikipedia.org/wiki/Flag_of_Lesotho" }],
  ["historical-flags/georgia-1990.svg", { from: 1990, to: 2004, design: "Georgia — dark red with black and white canton stripes, readopted in 1990 and replaced by the five-cross flag in 2004.", source: "https://en.wikipedia.org/wiki/Flag_of_Georgia_(country)" }],
  ["historical-flags/ethiopia-1991.svg", { from: 1991, to: 1996, design: "Ethiopia after the Derg — plain green, yellow and red; the blue disc emblem was added in 1996.", source: "https://en.wikipedia.org/wiki/Flag_of_Ethiopia" }],
  ["historical-flags/iraq-1991.svg", { from: 1991, to: 2004, design: "Iraq — red-white-black with three green stars and the takbir in Saddam Hussein's hand.", source: "https://en.wikipedia.org/wiki/Flag_of_Iraq" }],
  ["historical-flags/belarus-1991.svg", { from: 1991, to: 1995, design: "Belarus — the white-red-white flag of 1918, readopted at independence and replaced by referendum in 1995.", source: "https://en.wikipedia.org/wiki/Flag_of_Belarus" }],
  ["historical-flags/serbia-montenegro.svg", { from: 1992, to: 2006, design: "Federal Republic of Yugoslavia, later Serbia and Montenegro — blue, white and red without the socialist star.", source: "https://en.wikipedia.org/wiki/Flag_of_Serbia_and_Montenegro" }],
  ["historical-flags/bosnia-1992.svg", { from: 1992, to: 1998, design: "Republic of Bosnia and Herzegovina — white with the medieval Bosnian shield of fleurs-de-lis.", source: "https://en.wikipedia.org/wiki/Flag_of_Bosnia_and_Herzegovina" }],
  ["historical-flags/afghanistan-1992.svg", { from: 1992, to: 2001, design: "Islamic State of Afghanistan — green, white and black with the national emblem.", source: "https://en.wikipedia.org/wiki/Flag_of_Afghanistan" }],
  ["historical-flags/macedonia-1992.svg", { from: 1992, to: 1995, design: "Republic of Macedonia — the golden Vergina Sun on red, dropped in 1995 under the interim accord with Greece.", source: "https://en.wikipedia.org/wiki/Flag_of_North_Macedonia" }],
  ["historical-flags/montenegro-1993.svg", { from: 1993, to: 2004, design: "Republic of Montenegro within Yugoslavia — red, light blue and white.", source: "https://en.wikipedia.org/wiki/Flag_of_Montenegro" }],
  ["historical-flags/eritrea-1993.svg", { from: 1993, to: 1995, design: "Eritrea at independence — the 1993 flag, before the 1995 adjustment of the wreath emblem.", source: "https://en.wikipedia.org/wiki/Flag_of_Eritrea" }],
  ["historical-flags/kuwait-1914.svg", { from: 1914, to: 1921, design: "Kuwait — red with the state's name in white Arabic script.", source: "https://en.wikipedia.org/wiki/Flag_of_Kuwait" }],
  ["historical-flags/kuwait-1921.svg", { from: 1921, to: 1940, design: "Kuwait — red with the shahada and the state's name; the modern flag dates from 1961.", source: "https://en.wikipedia.org/wiki/Flag_of_Kuwait" }],
  ["historical-flags/andorra-1866.svg", { from: 1890, to: 1939, design: "Andorra — the blue-yellow-red tricolour with a crown, as flown around the turn of the 20th century. The arms were added in 1971.", source: "https://en.wikipedia.org/wiki/Flag_of_Andorra" }],
  ["historical-flags/syria-1930.svg", { from: 1930, to: 1963, design: "Syria — green-white-black with three red stars; flown 1930–1958 and again 1961–1963 (the union with Egypt intervened).", source: "https://en.wikipedia.org/wiki/Flag_of_Syria" }],
  ["historical-flags/oman-1970.svg", { from: 1970, to: 1995, design: "Oman — white, red and green with the state emblem, from Sultan Qaboos's accession; the proportions were fixed in 1995.", source: "https://en.wikipedia.org/wiki/Flag_of_Oman" }],
  ["historical-flags/syria-1980.svg", { from: 1980, to: 2024, design: "Syria — the red-white-black flag with two green stars, readopted in 1980 and flown until 2024.", source: "https://en.wikipedia.org/wiki/Flag_of_Syria" }],
  ["flags/trnc.svg", { from: 1984, to: 9999, design: "Turkish Republic of Northern Cyprus — white with a red crescent and star between red bands.", source: "https://en.wikipedia.org/wiki/Flag_of_Northern_Cyprus" }],
