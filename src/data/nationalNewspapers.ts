...
export const NATIONAL_NEWSPAPERS: Record<string, Newspaper[]> = {
  ...
  "BN": [
    {
      ...
      "owner": {
        "name": "Brunei Press Sdn Bhd",
        "type": "Commercial publisher"
      },
      "editorialStance": "Leading national English-language daily of Brunei Darussalam (Brunei Press); covers royal and government announcements, regional Southeast Asian affairs and local news.",
      "readership": {
        "metric": "Primary English-language daily across Brunei; digital edition via borneobulletin.com.bn",
        "source": "Borneo Bulletin Online; Brunei Press"
      },
      "revenueModel": "Print subscriptions, newsstand sales and advertising",
      "logo": "newspaper-logos/bn/borneo-bulletin.webp",
      "logoExplainer": "Official 2022 masthead: black serif 'Borneo Bulletin' over the all-caps strap 'THE INDEPENDENT NEWSPAPER IN BRUNEI DARUSSALAM, SABAH AND SARAWAK', from the newspaper's own site assets.",
      "sources": [
        "https://borneobulletin.com.bn",
        "https://en.wikipedia.org/wiki/Borneo_Bulletin"
      ],
      "licenceNote": "Borneo Bulletin masthead trademark bundled from the newspaper's official branding for educational reference in Learn mode."
    },
    {
      "id": "bn-media-permata",
      "countryCode": "BN",
      "name": "Media Permata",
      "englishTranslation": "Gem Media",
      "founded": 1998,
      "frequency": "Daily newspaper",
      "format": "Broadsheet & digital portal",
      "language": "Malay",
      ...
      "editorialStance": "Brunei's principal Malay-language daily (daily from 30 July 1998; began as a weekly Borneo Bulletin insert on 13 January 1994). Covers national affairs under the Malay Islamic Monarchy (MIB) frame, community and regional news.",
      "readership": {
        "metric": "Leading Malay-language daily in Brunei; digital edition via mediapermata.com.bn",
        "source": "Media Permata Profil Kami (mediapermata.com.bn/profil-kami)"
      },
      "revenueModel": "Print subscriptions, newsstand sales and advertising",
      "logo": "newspaper-logos/bn/media-permata.webp",
      "logoExplainer": "Official red serif 'Media Permata' wordmark used on the newspaper's own site and print branding (Brunei Press MP-LOGO asset).",
      "sources": [
        "https://mediapermata.com.bn",
        "https://mediapermata.com.bn/profil-kami/",
  ...
  "FJ": [
    {
      ...
      "owner": {
        "name": "Motibhai Group / Fiji Times Limited",
        "type": "Independent commercial publisher"
      },
      "editorialStance": "Fiji's oldest surviving newspaper (founded 4 September 1869) and historic newspaper of record; independent daily covering national politics, business and the wider Pacific.",
      "readership": {
        "metric": "Largest-circulation English-language daily in Fiji; continuous publication since 1869",
        "source": "The Fiji Times; standard Pacific media references"
      },
      "revenueModel": "Print subscriptions, newsstand sales, digital subscriptions and advertising",
      "logo": "newspaper-logos/fj/fiji-times.png",
      "logoExplainer": "Classic black serif masthead 'The Fiji Times' as published on fijitimes.com.fj (official site logo asset).",
      "sources": [
        "https://www.fijitimes.com.fj",
        "https://en.wikipedia.org/wiki/The_Fiji_Times"
      ],
      "licenceNote": "The Fiji Times masthead trademark bundled from the newspaper's official website for educational reference in Learn mode."
    },
    {
      "id": "fj-fiji-sun",
      "countryCode": "FJ",
      ...
      "format": "Tabloid & digital portal",
      "language": "English",
      "headquarters": "Walu Bay, Suva, Fiji",
      "owner": {
        "name": "Sun (Fiji) News Limited (CJ Patel Group)",
        "type": "Commercial publisher"
      },
      "editorialStance": "Fiji's second national daily (launched 24 September 1999); multi-platform print and digital coverage of politics, business, sport and community news.",
      "readership": {
        "metric": "National daily print run with strong digital reach across Fiji and the diaspora",
        "source": "Fiji Sun About Us (fijisun.com.fj/pages/about-us)"
      },
      "revenueModel": "Print sales, digital advertising and commercial partnerships",
      "logo": "newspaper-logos/fj/fiji-sun.webp",
      "logoExplainer": "Official Fiji Sun brand mark: italic white 'FIJI / Sun' wordmark with 'EST. 1999' on a red field, from the publisher's own brand assets.",
      "sources": [
        "https://fijisun.com.fj",
        "https://fijisun.com.fj/pages/about-us",
  ...
  "FM": [
    {
      ...
      "format": "Print tabloid & digital PDF edition",
      "language": "English",
      "headquarters": "Kolonia, Pohnpei, Federated States of Micronesia",
      "owner": {
        "name": "The Kaselehlie Press (independent)",
        "type": "Independent commercial publisher"
      },
      "editorialStance": "The Federated States of Micronesia's sole independent print newspaper of record (published since November 2000); covers the FSM Congress, the four state governments, environment and regional Pacific affairs. Advertiser-supported and distributed free.",
      "readership": {
        "metric": "Sole print newspaper serving all four FSM states; free bi-weekly distribution plus PDF edition",
        "source": "The Kaselehlie Press About Us (kpress.fm/about-us)"
      },
      "revenueModel": "Display advertising (free to readers)",
      "logo": "newspaper-logos/fm/the-kaselehlie-press.webp",
      "logoExplainer": "Print nameplate from the newspaper's own edition: olive-green wave rule over outlined serif 'The KASELEHLIE PRESS' with 'Free bi-weekly publication' strap.",
      "sources": [
        "https://kpress.fm",
        "https://kpress.fm/about-us/"
      ],
      "licenceNote": "The Kaselehlie Press masthead cropped from the newspaper's own print edition PDF, bundled for educational reference in Learn mode."
    }
  ],
  "FR": [
    {
  ...
  "KP": [
    {
      ...
      "frequency": "Daily newspaper",
      "format": "Broadsheet & digital edition",
      "language": "Korean (with foreign-language digital editions)",
      "headquarters": "Pyongyang, DPRK",
      "owner": {
        "name": "Central Committee of the Workers' Party of Korea",
        "type": "Party organ / state newspaper"
      },
      "editorialStance": "Official daily organ of the Central Committee of the Workers' Party of Korea; the country's principal newspaper of record for party and state policy.",
      "readership": {
        "metric": "Primary national print daily; widely distributed through party and workplace channels",
        "source": "Rodong Sinmun (rodong.rep.kp); standard reference works on DPRK media"
      },
      "revenueModel": "State / party allocation",
      "logo": "newspaper-logos/kp/rodong-sinmun.webp",
      "logoExplainer": "Official masthead from rodong.rep.kp: Workers' Party emblem (hammer, brush and sickle) beside red calligraphic Korean title 로동신문 with the site URL.",
      "sources": [
        "http://www.rodong.rep.kp",
        "https://en.wikipedia.org/wiki/Rodong_Sinmun",
        "https://commons.wikimedia.org/wiki/File:Rodong_Sinmun.png"
      ],
      "licenceNote": "Rodong Sinmun masthead from the newspaper's official site, bundled for educational reference in Learn mode."
    },
    {
      "id": "kp-minju-choson",
      "countryCode": "KP",
      ...
      "headquarters": "Pyongyang, DPRK",
      "owner": {
        "name": "Presidium of the Supreme People's Assembly and the Cabinet of the DPRK",
        "type": "State / government newspaper"
      },
      "editorialStance": "Official government daily of the Presidium of the Supreme People's Assembly and the Cabinet; covers civil administration, legal decrees and ministerial affairs alongside Rodong Sinmun's party line.",
      "readership": {
        "metric": "Second national daily after Rodong Sinmun; distributed through state and workplace channels",
        "source": "Minju Joson (minju.rep.kp); standard reference works on DPRK media"
      },
      "revenueModel": "State allocation",
      "logo": "newspaper-logos/kp/minju-choson.webp",
      "logoExplainer": "Official Korean-script masthead 민주조선 (Minju Choson / Minju Joson) as used by the newspaper's own branding.",
      "sources": [
        "http://www.minju.rep.kp",
        "https://en.wikipedia.org/wiki/Minju_Joson",
        "https://commons.wikimedia.org/wiki/File:Minju_Choson_Logo.png"
      ],
      "licenceNote": "Minju Choson masthead bundled for educational reference in Learn mode."
    }
  ],
  "KR": [
    {
  ...
  "LI": [
    {
      ...
      "englishTranslation": "Liechtenstein Fatherland",
      "founded": 1936,
      "frequency": "Daily newspaper (Monday–Saturday)",
      "format": "Compact print edition & digital portal",
      "language": "German",
      ...
      "editorialStance": "Liechtenstein's remaining national daily newspaper of record (after the 2023 closure of the Volksblatt). Historically aligned with the Patriotic Union (VU); covers Landtag politics, principality affairs and the Rhine Valley. Publisher has stated an intention to move toward political neutrality since absorbing Volksblatt subscribers.",
      "readership": {
        "metric": "Largest daily print circulation in Liechtenstein; sole remaining national printed daily since March 2023",
        "source": "Historisches Lexikon des Fürstentums Liechtenstein; FAZ reporting on Volksblatt closure (2023)"
      },
      ...
      "logoExplainer": "Official site masthead: red all-caps 'LIECHTENSTEINER' over a large black serif 'Vaterland', taken from vaterland.li (Vaduzer Medienhaus design system).",
      "sources": [
        "https://www.vaterland.li",
        "https://historisches-lexikon.li/Liechtensteiner_Vaterland",
        "https://en.wikipedia.org/wiki/Liechtensteiner_Vaterland"
      ],
      "licenceNote": "Liechtensteiner Vaterland masthead trademark bundled from the newspaper's official website for educational reference in Learn mode."
    },
    {
      "id": "li-volksblatt",
      "countryCode": "LI",
      "name": "Liechtensteiner Volksblatt",
      "englishTranslation": "Liechtenstein People's Sheet",
      "founded": 1878,
      "frequency": "Historical daily newspaper (ceased 4 March 2023)",
      "format": "Compact print edition (historical) & digital archive",
      "language": "German",
      ...
      "editorialStance": "Liechtenstein's oldest newspaper (1878–2023), historically the Progressive Citizens' Party (FBP) organ. Ceased print publication on 4 March 2023; subscribers were transferred to the Vaterland. Retained here as a historical national newspaper of record.",
      "readership": {
        "metric": "Peak circulation ~9,000 copies (2005); ~4,000 by 2022 before closure",
        "source": "Historisches Lexikon des Fürstentums Liechtenstein (Marxer)"
      },
      "revenueModel": "Historic subscriptions, advertising and (latterly) contested state press support",
      "logo": "newspaper-logos/li/liechtensteiner-volksblatt.svg",
      "logoExplainer": "2015 masthead wordmark 'Volksblatt' in blue-then-red serif lettering, digitised from the newspaper's own print PDF (Commons File:Liechtensteiner Volksblatt Logo 2015.svg).",
      "sources": [
        "https://historisches-lexikon.li/Liechtensteiner_Volksblatt",
        "https://en.wikipedia.org/wiki/Liechtensteiner_Volksblatt",
  ...
  "MC": [
    {
      ...
      "format": "Compact print edition & digital portal",
      "language": "French",
      "headquarters": "Monaco (editorial with Groupe Nice-Matin)",
      "owner": {
        "name": "Groupe Nice-Matin",
        "type": "Commercial regional publisher"
      },
      "editorialStance": "The Principality of Monaco's primary daily morning newspaper (Nice-Matin group); covers the Sovereign Prince and Palais Princier, Conseil National politics, and Riviera life.",
      "readership": {
        "metric": "Primary daily morning paper circulated across Monaco and the French Riviera",
        "source": "Monaco-Matin / Groupe Nice-Matin"
      },
      "revenueModel": "Print subscriptions, newsstand sales and advertising",
      "logo": "newspaper-logos/mc/monaco-matin.svg",
      "logoExplainer": "Official lowercase red sans-serif 'monaco-matin' wordmark used by Groupe Nice-Matin across monacomatin.mc and related brand assets.",
      "sources": [
  ...
  "MH": [
    {
      ...
      "owner": {
        "name": "The Marshall Islands Journal (privately owned)",
        "type": "Independent commercial publisher"
      },
      "editorialStance": "National newspaper of record for the Republic of the Marshall Islands (founded 1970 as the Micronitor by Joe Murphy and Mike Malone); bilingual weekly covering Nitijeļā, climate and nuclear-legacy issues, and regional Pacific affairs.",
      "readership": {
        "metric": "Circulation about 2,000 copies weekly (2018); sole national newspaper",
        "source": "The Marshall Islands Journal; Wikipedia citing 2018 circulation"
      },
      "revenueModel": "Subscriptions, newsstand sales and advertising",
      "logo": "newspaper-logos/mh/the-marshall-islands-journal.webp",
      "logoExplainer": "Official site masthead from marshallislandsjournal.com: illustrated lagoon/palm scene with bold blue 'The Marshall Islands Journal' title and 'newspaper of record in RMI' strap.",
      "sources": [
        "https://marshallislandsjournal.com",
        "https://en.wikipedia.org/wiki/The_Marshall_Islands_Journal"
      ],
      "licenceNote": "The Marshall Islands Journal masthead bundled from the newspaper's official website for educational reference in Learn mode."
    }
  ],
  "MK": [
    {
  ...
  "NP": [
    ...
    },
    {
      ...
      "format": "Broadsheet newspaper & digital portal (with affiliated Kantipur Television)",
      "language": "Nepali",
