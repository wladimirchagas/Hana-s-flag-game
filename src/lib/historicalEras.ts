...
const ERA_OVERRIDES: ReadonlyMap<Era["id"], ReadonlyMap<string, PolityInfo>> = new Map([
  ...
  ["ad1600", new Map<string, PolityInfo>([
    ...
    // European Powers
    ["Spain", { continent: "Europe / Americas / Asia / Africa", noFlag: true, note: "Spanish Empire — unified with Portugal (1580-1640 Iberian Union) under one crown; world's leading superpower with global empire from Americas to Asia (New Spain, Peru, Caribbean colonies).", population: 8_000_000 }],
    ["Portugal", { continent: "Europe / Americas / Asia / Africa", noFlag: true, note: "Portuguese Empire — unified with Spain (1580-1640 Iberian Union) under one crown; extensive Asian trade network (India, Japan) and Brazilian dominance; combined with Spanish power created world's largest empire.", population: 1_000_000 }],
