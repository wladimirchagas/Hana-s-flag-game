...
const ERA_OVERRIDES: ReadonlyMap<Era["id"], ReadonlyMap<string, PolityInfo>> = new Map([
  ...
  ["ad1600", new Map<string, PolityInfo>([
    ...
    // European Powers
    ["Iberian Union", { continent: "Europe / Americas / Asia / Africa", modernName: "Spain", note: "Iberian Union (1580-1640) — Spain and Portugal unified under one crown (Philip II onwards); world's leading superpower with global empire spanning from Americas (New Spain, Peru, Caribbean) to Asia (India, Japan trade monopoly) to Africa and Brazil. Includes all Spanish and Portuguese territories: Iberian Peninsula, Naples, Sicily, Sardinia, and overseas colonies.", population: 12_000_000 }],
